...
(function () {
  ...
  var PRODUCTS = [
    ...
    { id: 19, title: 'Ramo de Rosas Inicial N', price: 100000, img: 'assets/rosas_n.jpg', tag: 'Verano', desc: 'Ramo de rosas rojas con inicial N en flores blancas.' },
    { id: 20, title: 'Ramo de Rosas Inicial F', price: 100000, img: 'assets/rosas_f.png', tag: 'Verano', desc: 'Ramo de rosas rojas con inicial F en flores blancas.' },
    { id: 21, title: 'Ramo de Rosas Inicial A con Corona', price: 120000, img: 'assets/rosas_a.png', tag: 'Verano', desc: 'Ramo de rosas rojas con inicial A y una elegante corona.' },
    { id: 22, title: 'Ramo de Girasoles Rústico', price: 100000, img: 'assets/girasoles_2.png', tag: 'Verano', desc: 'Luminoso ramo de girasoles envuelto en papel craft.' },
    { id: 23, title: 'Ramo de Claveles Rosados', price: 100000, img: 'assets/claveles_1.png', tag: 'Verano', desc: 'Delicado ramo de claveles rosados y gypsophila.' },
    { id: 24, title: 'Ramo de Astromelias Clásico', price: 100000, img: 'assets/astromelias_3.jpg', tag: 'Verano', desc: 'Ramo clásico de astromelias rosadas y blancas.' },
    { id: 25, title: 'Ramo de Margaritas Gigante', price: 150000, img: 'assets/margaritas_3.jpg', tag: 'Verano', desc: 'Gran arreglo de margaritas blancas frescas.' },
    { id: 26, title: 'Ramo de Claveles Simples', price: 100000, img: 'assets/claveles_2.jpg', tag: 'Verano', desc: 'Hermoso ramo de claveles rosados y gypsophila.' },
    { id: 27, title: 'Ramo de Claveles Especial', price: 120000, img: 'assets/claveles_3.png', tag: 'Verano', desc: 'Arreglo especial de claveles en tonos rosas.' },
    { id: 28, title: 'Ramo de Claveles Premium', price: 150000, img: 'assets/claveles_4.png', tag: 'Verano', desc: 'Lujoso ramo de claveles rosados con follaje.' },
