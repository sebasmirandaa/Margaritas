...
(function () {
  ...
  var PRODUCTS = [
    ...
    { id: 9, title: 'Lirio de Primavera', price: 100000, img: 'assets/flowers/lirio_9.jpg', tag: 'Primavera', desc: 'Hermosa flor de Lirio seleccionada para la temporada de Primavera.' },
    { id: 10, title: 'Petunia de Primavera', price: 100000, img: 'assets/flowers/petunia_10.jpg', tag: 'Primavera', desc: 'Hermosa flor de Petunia seleccionada para la temporada de Primavera.' },
    { id: 11, title: 'Caléndula de Primavera', price: 100000, img: 'assets/flowers/calendula_11.jpg', tag: 'Primavera', desc: 'Hermosa flor de Caléndula seleccionada para la temporada de Primavera.' },
    { id: 12, title: 'Girasol de Primavera', price: 100000, img: 'assets/flowers/girasol_12.jpg', tag: 'Primavera', desc: 'Hermosa flor de Girasol seleccionada para la temporada de Primavera.' },
    { id: 13, title: 'Gerbera de Primavera', price: 100000, img: 'assets/flowers/gerbera_13.jpg', tag: 'Primavera', desc: 'Hermosa flor de Gerbera seleccionada para la temporada de Primavera.' },
    { id: 14, title: 'Narciso de Primavera', price: 100000, img: 'assets/flowers/narciso_14.jpg', tag: 'Primavera', desc: 'Hermosa flor de Narciso seleccionada para la temporada de Primavera.' },
    { id: 15, title: 'Girasol de Verano', price: 100000, img: 'assets/flowers/girasol_15.jpg', tag: 'Verano', desc: 'Hermosa flor de Girasol seleccionada para la temporada de Verano.' },
    { id: 16, title: 'Rosa de Verano', price: 100000, img: 'assets/flowers/rosa_16.jpg', tag: 'Verano', desc: 'Hermosa flor de Rosa seleccionada para la temporada de Verano.' },
    { id: 17, title: 'Hibisco de Verano', price: 100000, img: 'assets/flowers/hibisco_17.jpg', tag: 'Verano', desc: 'Hermosa flor de Hibisco seleccionada para la temporada de Verano.' },
    { id: 18, title: 'Hortensia de Verano', price: 100000, img: 'assets/flowers/hortensia_18.jpg', tag: 'Verano', desc: 'Hermosa flor de Hortensia seleccionada para la temporada de Verano.' },
    { id: 19, title: 'Zinnia de Verano', price: 100000, img: 'assets/flowers/zinnia_19.jpg', tag: 'Verano', desc: 'Hermosa flor de Zinnia seleccionada para la temporada de Verano.' },
    { id: 20, title: 'Dalia de Verano', price: 100000, img: 'assets/flowers/dalia_20.jpg', tag: 'Verano', desc: 'Hermosa flor de Dalia seleccionada para la temporada de Verano.' },
    { id: 21, title: 'Lavanda de Verano', price: 100000, img: 'assets/flowers/lavanda_21.jpg', tag: 'Verano', desc: 'Hermosa flor de Lavanda seleccionada para la temporada de Verano.' },
    { id: 22, title: 'Buganvilla de Verano', price: 100000, img: 'assets/flowers/buganvilla_22.jpg', tag: 'Verano', desc: 'Hermosa flor de Buganvilla seleccionada para la temporada de Verano.' },
    { id: 23, title: 'Cosmos de Verano', price: 100000, img: 'assets/flowers/cosmos_23.jpg', tag: 'Verano', desc: 'Hermosa flor de Cosmos seleccionada para la temporada de Verano.' },
    { id: 24, title: 'Lirio de Verano', price: 100000, img: 'assets/flowers/lirio_24.jpg', tag: 'Verano', desc: 'Hermosa flor de Lirio seleccionada para la temporada de Verano.' },
    { id: 25, title: 'Celosia de Verano', price: 100000, img: 'assets/flowers/celosia_25.jpg', tag: 'Verano', desc: 'Hermosa flor de Celosia seleccionada para la temporada de Verano.' },
    { id: 26, title: 'Jazmín de Verano', price: 100000, img: 'assets/flowers/jazmin_26.jpg', tag: 'Verano', desc: 'Hermosa flor de Jazmín seleccionada para la temporada de Verano.' },
    { id: 27, title: 'Portulaca de Verano', price: 100000, img: 'assets/flowers/portulaca_27.jpg', tag: 'Verano', desc: 'Hermosa flor de Portulaca seleccionada para la temporada de Verano.' },
    { id: 28, title: 'Geranio de Verano', price: 100000, img: 'assets/flowers/geranio_28.jpg', tag: 'Verano', desc: 'Hermosa flor de Geranio seleccionada para la temporada de Verano.' },
    { id: 29, title: 'Gazania de Verano', price: 100000, img: 'assets/flowers/gazania_29.jpg', tag: 'Verano', desc: 'Hermosa flor de Gazania seleccionada para la temporada de Verano.' },
    { id: 30, title: 'Crisantemo de Otoño', price: 100000, img: 'assets/flowers/crisantemo_30.jpg', tag: 'Otoño', desc: 'Hermosa flor de Crisantemo seleccionada para la temporada de Otoño.' },
    { id: 31, title: 'Rosa de Otoño', price: 100000, img: 'assets/flowers/rosa_31.jpg', tag: 'Otoño', desc: 'Hermosa flor de Rosa seleccionada para la temporada de Otoño.' },
    { id: 32, title: 'Dalia de Otoño', price: 100000, img: 'assets/flowers/dalia_32.jpg', tag: 'Otoño', desc: 'Hermosa flor de Dalia seleccionada para la temporada de Otoño.' },
    { id: 33, title: 'Aster de Otoño', price: 100000, img: 'assets/flowers/aster_33.jpg', tag: 'Otoño', desc: 'Hermosa flor de Aster seleccionada para la temporada de Otoño.' },
    { id: 34, title: 'Caléndula de Otoño', price: 100000, img: 'assets/flowers/calendula_34.jpg', tag: 'Otoño', desc: 'Hermosa flor de Caléndula seleccionada para la temporada de Otoño.' },
    { id: 35, title: 'Pensamiento de Otoño', price: 100000, img: 'assets/flowers/pensamiento_35.jpg', tag: 'Otoño', desc: 'Hermosa flor de Pensamiento seleccionada para la temporada de Otoño.' },
    { id: 36, title: 'Begonia de Otoño', price: 100000, img: 'assets/flowers/begonia_36.jpg', tag: 'Otoño', desc: 'Hermosa flor de Begonia seleccionada para la temporada de Otoño.' },
    { id: 37, title: 'Cosmos de Otoño', price: 100000, img: 'assets/flowers/cosmos_37.jpg', tag: 'Otoño', desc: 'Hermosa flor de Cosmos seleccionada para la temporada de Otoño.' },
    { id: 38, title: 'Hortensia de Otoño', price: 100000, img: 'assets/flowers/hortensia_38.jpg', tag: 'Otoño', desc: 'Hermosa flor de Hortensia seleccionada para la temporada de Otoño.' },
    { id: 39, title: 'Salvia de Otoño', price: 100000, img: 'assets/flowers/salvia_39.jpg', tag: 'Otoño', desc: 'Hermosa flor de Salvia seleccionada para la temporada de Otoño.' },
    { id: 40, title: 'Alstroemeria de Otoño', price: 100000, img: 'assets/flowers/alstroemeria_40.jpg', tag: 'Otoño', desc: 'Hermosa flor de Alstroemeria seleccionada para la temporada de Otoño.' },
    { id: 41, title: 'Camelia de Otoño', price: 100000, img: 'assets/flowers/camelia_41.jpg', tag: 'Otoño', desc: 'Hermosa flor de Camelia seleccionada para la temporada de Otoño.' },
    { id: 42, title: 'Clavel de Otoño', price: 100000, img: 'assets/flowers/clavel_42.jpg', tag: 'Otoño', desc: 'Hermosa flor de Clavel seleccionada para la temporada de Otoño.' },
    { id: 43, title: 'Margarita de Otoño', price: 100000, img: 'assets/flowers/margarita_43.jpg', tag: 'Otoño', desc: 'Hermosa flor de Margarita seleccionada para la temporada de Otoño.' },
    { id: 44, title: 'Verbena de Otoño', price: 100000, img: 'assets/flowers/verbena_44.jpg', tag: 'Otoño', desc: 'Hermosa flor de Verbena seleccionada para la temporada de Otoño.' },
    { id: 45, title: 'Rosa de Invierno', price: 100000, img: 'assets/flowers/rosa_45.jpg', tag: 'Invierno', desc: 'Hermosa flor de Rosa seleccionada para la temporada de Invierno.' },
    { id: 46, title: 'Camelia de Invierno', price: 100000, img: 'assets/flowers/camelia_46.jpg', tag: 'Invierno', desc: 'Hermosa flor de Camelia seleccionada para la temporada de Invierno.' },
    { id: 47, title: 'Ciclamen de Invierno', price: 100000, img: 'assets/flowers/ciclamen_47.jpg', tag: 'Invierno', desc: 'Hermosa flor de Ciclamen seleccionada para la temporada de Invierno.' },
    { id: 48, title: 'Pensamiento de Invierno', price: 100000, img: 'assets/flowers/pensamiento_48.jpg', tag: 'Invierno', desc: 'Hermosa flor de Pensamiento seleccionada para la temporada de Invierno.' },
    { id: 49, title: 'Prímula de Invierno', price: 100000, img: 'assets/flowers/primula_49.jpg', tag: 'Invierno', desc: 'Hermosa flor de Prímula seleccionada para la temporada de Invierno.' },
    { id: 50, title: 'Begonia de Invierno', price: 100000, img: 'assets/flowers/begonia_50.jpg', tag: 'Invierno', desc: 'Hermosa flor de Begonia seleccionada para la temporada de Invierno.' },
    { id: 51, title: 'Caléndula de Invierno', price: 100000, img: 'assets/flowers/calendula_51.jpg', tag: 'Invierno', desc: 'Hermosa flor de Caléndula seleccionada para la temporada de Invierno.' },
    { id: 52, title: 'Jazmín de invierno', price: 100000, img: 'assets/flowers/jazmin_52.jpg', tag: 'Invierno', desc: 'Hermosa flor de Jazmín de invierno seleccionada para la temporada de Invierno.' },
    { id: 53, title: 'Azalea de Invierno', price: 100000, img: 'assets/flowers/azalea_53.jpg', tag: 'Invierno', desc: 'Hermosa flor de Azalea seleccionada para la temporada de Invierno.' },
    { id: 54, title: 'Narciso de Invierno', price: 100000, img: 'assets/flowers/narciso_54.jpg', tag: 'Invierno', desc: 'Hermosa flor de Narciso seleccionada para la temporada de Invierno.' },
    { id: 55, title: 'Tulipán de Invierno', price: 100000, img: 'assets/flowers/tulipan_55.jpg', tag: 'Invierno', desc: 'Hermosa flor de Tulipán seleccionada para la temporada de Invierno.' },
    { id: 56, title: 'Violeta de Invierno', price: 100000, img: 'assets/flowers/violeta_56.jpg', tag: 'Invierno', desc: 'Hermosa flor de Violeta seleccionada para la temporada de Invierno.' },
    { id: 57, title: 'Mahonia de Invierno', price: 100000, img: 'assets/flowers/mahonia_57.jpg', tag: 'Invierno', desc: 'Hermosa flor de Mahonia seleccionada para la temporada de Invierno.' },
    { id: 58, title: 'Helleboro de Invierno', price: 100000, img: 'assets/flowers/helleboro_58.jpg', tag: 'Invierno', desc: 'Hermosa flor de Helleboro seleccionada para la temporada de Invierno.' },
    { id: 59, title: 'Alhelí de Invierno', price: 100000, img: 'assets/flowers/alheli_59.jpg', tag: 'Invierno', desc: 'Hermosa flor de Alhelí seleccionada para la temporada de Invierno.' }
  ];
